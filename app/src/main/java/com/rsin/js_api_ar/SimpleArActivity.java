...
//        final SampleData sampleData = (SampleData) intent.getSerializableExtra(INTENT_EXTRAS_KEY_SAMPLE);
        arExperience ="07_3dModels_4_SnapToScreen/index.html";
        ...
        config.setLicenseKey(getString(R.string.key)); // Has to be set, to get a trial license key visit http://www.wikitude.com/developer/licenses.
